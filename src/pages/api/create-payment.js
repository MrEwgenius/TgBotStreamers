    ...
    try {
      const response = await fetch("https://api.cryptocloud.plus/v1/invoice/create", {
        ...
        headers: {
          ...
          Authorization: `Token eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1dWlkIjoiTXpnek5Eaz0iLCJ0eXBlIjoicHJvamVjdCIsInYiOiI4Y2JhYTU2ZWRiMzMyOTI2YjcxNjNlNTc0OTA0MmZiMThmNDQ0ODBkNTZlOWE0YWY5MGNjYzcwODM5MmQ0YTMxIiwiZXhwIjo4ODEzNzYxOTE4N30.2rGSiAP7RcPnfNPuB5ySMvDmcg_o6kyLnsMt9Nu_TeI`, // Замените на ваш API-ключ
        },
        body: JSON.stringify({
          shop_id: "oCu9otDwwj0vB4Js", // Замените на ваш shop_id
          amount,
          currency,
          order_id,
